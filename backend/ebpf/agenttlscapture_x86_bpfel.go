...
type AgentTlsCaptureProgramSpecs struct {
	...
	UprobeRustlsConsumeFirstChunk *ebpf.ProgramSpec `ebpf:"uprobe_rustls_consume_first_chunk"`
...
type AgentTlsCapturePrograms struct {
	...
	UprobeRustlsConsumeFirstChunk *ebpf.Program `ebpf:"uprobe_rustls_consume_first_chunk"`
...
func (p *AgentTlsCapturePrograms) Close() error {
	return _AgentTlsCaptureClose(
		...
		p.UprobePrRead,
		p.UprobePrWrite,
		p.UprobeRustlsConsumeFirstChunk,
