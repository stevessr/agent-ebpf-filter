...
// NewModelTrainer returns a trainer with default log capacity, ready for use.
...
// Features exposes the feature vector for callers outside this package.
func (s TrainSample) Features() [FeatureDim]float64 { return s.features }

// Label exposes the class label for callers outside this package.
func (s TrainSample) Label() int32 { return s.label }

// NewTrainSample builds a sample from raw parts for callers outside this package.
func NewTrainSample(features [FeatureDim]float64, label int32) TrainSample {
