...
func BuiltinProfiles() []Profile {
	return []Profile{
		...
		// Provider identification is independent of the caller harness (mcode, zcode,
		// Claude Code, etc.). Restrict vendor attribution to MiniMax API hosts;
		// matching a compatible route alone must not imply MiniMax.
		{ID: "minimax.messages", Vendor: "minimax", Product: "messages", Operation: "messages.create", Protocols: []string{"http1", "http2"}, Methods: []string{"POST"}, HostSuffixes: []string{"api.minimax.io", "api.minimaxi.com"}, PathPrefixes: []string{"/anthropic/v1/messages", "/v1/messages"}, MinScore: 90},
		{ID: "minimax.chat-completions", Vendor: "minimax", Product: "chat-completions", Operation: "chat.completions.create", Protocols: []string{"http1", "http2"}, Methods: []string{"POST"}, HostSuffixes: []string{"api.minimax.io", "api.minimaxi.com"}, PathPrefixes: []string{"/v1/chat/completions", "/v1/text/chatcompletion_v2"}, MinScore: 90},
		{ID: "minimax.responses", Vendor: "minimax", Product: "responses", Operation: "responses.create", Protocols: []string{"http1", "http2"}, Methods: []string{"POST"}, HostSuffixes: []string{"api.minimax.io", "api.minimaxi.com"}, PathPrefixes: []string{"/v1/responses"}, MinScore: 90},
