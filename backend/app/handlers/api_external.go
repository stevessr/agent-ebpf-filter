...
func BuildExternalOpenAPISpec() *openapi3.T {
	...
	addOperation(paths, "/research/sessions/{id}/tasks", http.MethodPost, "Queue an asynchronous research task: scan_recent, build_session, compare_windows, security_eval, export_bundle, reset_session.")
	...
	addOperation(paths, "/research/sessions/{id}/results", http.MethodGet, "Get backend-computed research aggregates, process/trace/timeline summaries, loop findings, risk alerts, and security evaluation reports.")
	...
	addOperation(paths, "/research/sessions/{id}/export", http.MethodGet, "Download generated research artifact. Query: format=jsonl|csv|json|bundle|security-json|security-jsonl|security-csv.")
