...
func TestIsAgentTLSProcessRecognizesModernAgentRuntimes(t *testing.T) {
	tests := []struct {
		...
		{name: "ZCode native", base: "zcode", want: true},
		{name: "MiniMax Code native", base: "mcode", want: true},
		{name: "MiniMax Code npm runtime", base: "node", cmdline: "node /opt/node_modules/@minimax-ai/code/dist/cli.js", want: true},
		{name: "MiniMax Code installer runtime", base: "node", cmdline: "node /home/user/.minimax-code/bin/mcode", want: true},
		{name: "ZCode CLI Node runtime", base: "node", cmdline: "node /home/user/.zcode/cli/runner.js", want: true},
		{name: "unrelated zcode string", base: "node", cmdline: "node /opt/project/zcode-demo.js", want: false},
		{name: "unrelated minimax string", base: "node", cmdline: "node /opt/project/minimax-api-proxy.js", want: false},
