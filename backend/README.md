...
- `/research/sessions`, `/research/sessions/:id/tasks`, `/research/tasks/:taskId`, `/research/sessions/:id/events`, `/research/sessions/:id/results`, `/research/sessions/:id/training?format=json|jsonl|csv`, `/research/sessions/:id/training/import`, `/research/sessions/:id/export?format=jsonl|csv|bundle` — Research Processing v2 workbench APIs for persisted normalized research sessions, async scans/comparisons/exports, loop/risk correlations, training-ready 128-dim structured samples, and JSONL/CSV/bundle artifacts with manifests
