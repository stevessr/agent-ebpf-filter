...
PPT 内已使用 `[1]`–`[6]` 顺序编码标注统计数据、案例和风险框架来源，并在 Slide 21 追加“参考文献”页。参考文献页按中国大陆论文通行习惯整理，网络资源类型统一标注为 `[EB/OL]`，并标明访问日期。
...
- Slide 21：新增“参考文献”页，按 `[序号] 责任者. 题名[EB/OL]. 发布/更新年份 [访问日期]. URL` 风格列出 Stack Overflow、GitGuardian、IBM、OWASP、CSA、NVD 等来源。
...
- 抽查 Slide 3、20、21：数据页使用“资料来源”页脚；总结页提示 GB/T 7714 常用格式；参考文献页采用 `[EB/OL]` 网络文献著录格式。
