...
成功扩展了 MCP 服务，新增了 8 个实用工具覆盖配置管理、事件查询、监控和安全策略；创建了 3 个高质量的 Claude Code skills 提供完整的使用指南；更新了项目文档确保开发者能够正确使用这些功能。整个优化为 agent-ebpf-filter 项目提供了更强大的可编程接口和更便捷的操作方式。
