...
| AgentSight 事件处理速度 | `../_archive/agentsight-optimization-summary.md` | 可展示 10,000 events 下处理优化 |
| eBPF 代码维护性 | `../_archive/ebpf-optimization-summary.md` | 展示 syscall handler 代码减少和可维护性提升 |
