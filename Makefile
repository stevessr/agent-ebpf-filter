...
.PHONY: all backend frontend wrapper clean proto proto-check help predev predev-check predev-go predev-python predev-frontend dev dev-env dev-env-print dev-env-doctor run deps ebpf-bootstrap ebpf-tls ebpf-cgroup ebpf-lsm os-enforcement-preflight os-enforcement-check os-enforcement-smoke os-enforcement-smoke-start cuda ml-sweep ml-presentation runtime-benchmark test build install uninstall docker dev-image dev-image-repository dev-image-tag exec
...
dev-env: ## Interactively configure local development environment variables
