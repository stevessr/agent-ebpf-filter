...
DEV_ENV_EXPORTS := DEV_ENV_FILE DEV_ENV_MAKEFILE DISABLE_AUTH GIN_MODE AGENT_EBPF_DEV_SESSION AGENT_WRAPPER_PATH CONTAINER_CLI DEV_BRANCH DEV_IMAGE_REPOSITORY DEV_IMAGE_TAG DEV_IMAGE DEV_CONTAINER DEV_WORKSPACE DEVCONTAINER_POSTCREATE_INSTALL CUDA_GO_TAGS OS_SMOKE_PRIVILEGE_CMD
