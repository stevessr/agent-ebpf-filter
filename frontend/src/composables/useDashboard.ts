...
import { minColumnWidths, pageSizeOptions, eventTypeLabelMap, eventTypeColorMap, selectableEventTypes, networkEventTypes, eventCategories, categoryTabs, syscallCatLabels, syscallCatColors, parseSyscallNr, syscallCategory, syscallDisplayName, builtinFilterRules, baseColumns, type AgentEvent, type BuiltinFilterRule } from './dashboardConstants';
