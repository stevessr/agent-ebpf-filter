...
export const quickRulePresets: SecurityRulePreset[] = [
  ...
  },
  {
    ...
    action: "ALERT",
    priority: 180,
    source: "Gemini CLI / Codex CLI",
    summary: "对 git 操作（含 clone, push --force, reset --hard）提醒确认",
  },
  {
    comm: "curl",
    action: "ALERT",
  ...
  // ── Codex CLI (sandbox + ExecPolicyManager) ──
  {
    ...
    priority: 190,
    source: "Codex CLI",
    summary: "find -exec/-delete/-fls/-fprint — 高风险查找操作，可执行任意命令",
  },
  {
    comm: "base64",
    action: "ALERT",
    priority: 170,
    source: "Codex CLI",
    summary: "base64 -o/--output — 潜在的数据外泄或文件覆写",
  },
  {
    comm: "rg",
    action: "ALERT",
    priority: 170,
    source: "Codex CLI",
    summary: "rg --pre/--hostname-bin/--search-zip — 自定义命令/外部工具执行",
  },
  {
    comm: "pwsh",
    action: "ALERT",
    priority: 190,
    source: "Codex CLI",
    summary: "PowerShell — 带有副作用的 cmdlet 执行",
  },
  {
    comm: "powershell",
    action: "ALERT",
    priority: 190,
    source: "Codex CLI",
    summary: "PowerShell — Windows shell 执行，可能绕过简单模式匹配",
  },
  ...
  // ── Claude Code (bash deny rules + permission hardening) ──
  {
    ...
    priority: 150,
    source: "Claude Code",
    summary: "env 包装器 — 可能用于绕过命令黑名单或泄露环境变量",
  },
  {
    comm: "watch",
    action: "ALERT",
    priority: 150,
    source: "Claude Code",
    summary: "watch 包装器 — 重复执行命令，可能放大破坏性操作",
  },
  {
    comm: "ionice",
    action: "ALERT",
    priority: 150,
    source: "Claude Code",
    summary: "ionice — I/O 优先级操纵，可能隐藏恶意 I/O 活动",
  },
  {
    comm: "setsid",
    action: "ALERT",
    priority: 150,
    source: "Claude Code",
    summary: "setsid — 从终端分离进程，绕过进程组管理",
  },
  {
    comm: "nc",
    action: "BLOCK",
    priority: 200,
    source: "Claude Code",
    summary: "nc (netcat) — 反向 shell / 网络后门 / 未授权监听",
  },
  {
    comm: "nmap",
    action: "BLOCK",
  ...
  },
  {
    ...
    priority: 160,
    source: "Cursor",
    summary: "pip install — 安装可能带有供应链风险的包",
  },
  {
    comm: "sh",
    action: "ALERT",
  ...
  },
  {
    ...
    priority: 160,
    source: "Cursor",
    summary: "open — macOS 上启动应用程序或打开文件/URL",
  },
  {
    comm: "start",
    action: "ALERT",
    priority: 160,
    source: "Cursor",
    summary: "start — Windows 上启动进程或打开文件",
  },
  {
    comm: "ssh",
    action: "ALERT",
    priority: 170,
    source: "Cursor",
    summary: "ssh — 远程 shell / 网络隧道 / 出站连接",
  },
  {
    comm: "killall",
    action: "BLOCK",
  ...
  // ── Amazon Q incident (cloud resource destruction) ──
  {
    ...
    action: "ALERT",
    priority: 190,
    source: "Amazon Q incident",
    summary: "aws ec2 terminate / s3 rm / iam delete — 云资源破坏性操作",
  },
  ...
  // ── General shell/security critical ──
  {
    ...
    priority: 180,
    source: "Cross-agent baseline",
    summary: "wget -O — 将文件下载到磁盘，可能为恶意 payload",
  },
  {
    comm: "chroot",
    action: "BLOCK",
  ...
  },
  {
    ...
    priority: 180,
    source: "Cross-agent baseline",
    summary: "iptables — 防火墙规则操纵（清空/放行/重定向）",
  },
  {
    comm: "crontab",
    action: "ALERT",
  ...
  // ── Claude Code Safety Net (git/rm/find/xargs deep analysis) ──
  {
    ...
    action: "ALERT",
    priority: 190,
    source: "Claude Code Safety Net",
    summary: "xargs — 批量管道执行，可能将不可信输入传递给危险命令",
  },
  {
    comm: "git",
    action: "ALERT",
    ...
    source: "Claude Code Safety Net",
    summary:
      "git reset --hard / clean -f / push --force 等破坏性操作需人工确认",
  },
  {
    comm: "rm",
    action: "BLOCK",
    priority: 195,
    source: "Claude Code Safety Net",
    summary: "rm -rf 根/家目录或超出 cwd 范围始终阻止；/tmp 允许",
  },
  {
    comm: "watch",
    action: "ALERT",
    priority: 170,
    source: "Claude Code Safety Net",
    summary: "watch — 重复执行命令，可能放大破坏性操作的影响",
  },
  {
    comm: "ionice",
    action: "ALERT",
  ...
  },
  {
    ...
    priority: 170,
    source: "Claude Code Safety Net",
    summary: "setsid — 从终端分离进程，绕过进程组管理和信号控制",
  },
  {
    comm: "mount",
    action: "ALERT",
    priority: 175,
    source: "Claude Code Safety Net",
    summary: "mount --bind — bind mount 可能用于容器/jail 逃逸",
  },
];
...
export const externalRuleSources: ExternalRuleSource[] = [
  ...
  },
  {
    ...
    description:
      "OWASP 针对 AI 代理安全的 Top 10 指导方针（固定预设，非远程获取）",
    url: "",
    format: "markdown",
...
export const owaspPresets: SecurityRulePreset[] = [
  ...
  },
  {
    ...
    priority: 190,
    source: "OWASP Agentic AI",
    summary: "避免 AI 代理执行 Azure 资源破坏性操作",
  },
  {
    comm: "terraform",
    action: "ALERT",
    priority: 180,
    source: "OWASP Agentic AI",
    summary: "terraform destroy / apply 需人工确认",
  },
  {
    comm: "kubectl",
    action: "ALERT",
    priority: 180,
    source: "OWASP Agentic AI",
    summary: "kubectl delete 需人工确认，防止集群资源误删",
  },
];
...
export const syscallGroups: SyscallGroup[] = [
  ...
  },
  {
    ...
    syscalls: [
      {
        type: pb.EventType.NETWORK_CONNECT,
        name: "connect",
        desc: "Outgoing TCP/UDP connection",
      },
      {
        type: pb.EventType.NETWORK_BIND,
        name: "bind",
        desc: "Bind socket to address/port",
      },
      {
        type: pb.EventType.NETWORK_SENDTO,
        name: "sendto",
        desc: "Send data to socket",
      },
      {
        type: pb.EventType.NETWORK_RECVFROM,
        name: "recvfrom",
        desc: "Receive data from socket",
      },
      {
        type: pb.EventType.SOCKET,
        name: "socket",
        desc: "Create socket endpoint",
      },
      {
        type: pb.EventType.ACCEPT,
        name: "accept",
        desc: "Accept incoming connection",
      },
      {
        type: pb.EventType.ACCEPT4,
        name: "accept4",
        desc: "Accept4 connection (with flags)",
      },
    ],
  },
  {
    ...
    syscalls: [
      {
        type: pb.EventType.EXECVE,
        name: "execve",
        desc: "Execute a new program",
      },
      {
        type: pb.EventType.CLONE,
        name: "clone",
        desc: "Create child process/thread",
      },
  ...
  },
  {
    ...
    syscalls: [
      {
        type: pb.EventType.IOCTL,
        name: "ioctl",
        desc: "Device I/O control operation",
      },
    ],
  },
  {
