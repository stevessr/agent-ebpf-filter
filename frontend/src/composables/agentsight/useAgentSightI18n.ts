...
const messages: Record<Locale, Record<AgentSightMessageKey, string>> = {
  en: {
    ...
    compatDescription:
      "This page consumes unified EventEnvelope history and exposes Log, Timeline, Process Tree, Flamegraph, and Metrics views for TLS, HTTP/SSE, process, policy, wrapper, hook, MCP, stdio, and system events.",
    ...
    pastePlaceholder:
      "Paste JSON, JSONL, or AgentSight sample trace records here",
  ...
  zh: {
    ...
    compatDescription:
      "此页面消费统一 EventEnvelope 历史与实时流，提供 Log、Timeline、Process Tree、Flamegraph、Metrics 视图，覆盖 TLS、HTTP/SSE、进程、策略、wrapper、hook、MCP、stdio 和 system 事件。",
