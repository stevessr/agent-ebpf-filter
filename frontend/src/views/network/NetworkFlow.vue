...
const {
  ...
  protocolColor, stateColor, staleColor, riskColor,
  getTrafficLevelColor, getTrafficLevelLabel,
        ...
        <a-card size="small" :bordered="false" style="background: #fff7e6;">
          <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <div>
              ...
              <div style="font-size: 22px; font-weight: bold; color: #fa8c16;">{{ flowList.length }}</div>
            </div>
          </div>
        </a-card>
      </a-col>
