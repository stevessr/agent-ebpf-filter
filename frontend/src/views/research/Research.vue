...
import ResearchSecurityEvaluationTab from "./ResearchSecurityEvaluationTab.vue";
import ResearchTrainingDatasetTab from "./ResearchTrainingDatasetTab.vue";
import {
  eventFeaturePreview,
  eventRowKey,
  topCounts,
          ...
          <template v-else>
            ...
            <a-tabs class="research-tabs">
              ...
              <a-tab-pane key="security" tab="Security Eval">
                <ResearchSecurityEvaluationTab
                  v-model:security-evaluation-mode="securityEvaluationMode"
                  v-model:security-evaluation-limit="securityEvaluationLimit"
                  v-model:security-evaluation-include-l-l-m="securityEvaluationIncludeLLM"
                  v-model:security-evaluation-label-policy="securityEvaluationLabelPolicy"
                  :selected-session-id="selectedSessionId"
                  :submitting-task="submittingTask"
                  :exporting-security-evaluation="exportingSecurityEvaluation"
                  :security-evaluation="securityEvaluation"
                  :security-evaluation-preview-samples="securityEvaluationPreviewSamples"
                  :risk-color="riskColor"
                  :format-time="formatTime"
                  @run="runSecurityEvaluation"
                  @download="downloadSecurityEvaluation"
                />
              </a-tab-pane>

              <a-tab-pane key="training" tab="Training Dataset">
                <ResearchTrainingDatasetTab
                  v-model:research-training-label-policy="researchTrainingLabelPolicy"
                  v-model:research-training-import-limit="researchTrainingImportLimit"
                  :selected-session-id="selectedSessionId"
                  :loading-research-training="loadingResearchTraining"
                  :importing-research-training="importingResearchTraining"
                  :exporting-research-training="exportingResearchTraining"
                  :research-training-dataset="researchTrainingDataset"
                  :research-training-import-result="researchTrainingImportResult"
                  :research-training-preview-samples="researchTrainingPreviewSamples"
                  :risk-color="riskColor"
                  :format-time="formatTime"
                  @preview="fetchResearchTrainingDataset"
                  @import-dataset="importResearchTrainingDataset"
                  @download="downloadResearchTrainingDataset"
                />
              </a-tab-pane>
...
<style scoped src="./researchView.css"></style>
