      ...
      <div class="docs-preview-shell">
        <div class="docs-preview-meta">
          <div class="docs-preview-meta__head">
            ...
            <a-space size="small" wrap>
              ...
              <a-tag :color="entry.kind === 'syscall' ? 'blue' : 'green'">{{
                kindText
              }}</a-tag>
          ...
          <div class="docs-preview-meta__details">
            ...
            <span
              >Cached path:
              <code class="docs-preview-inline-code">{{
                entry.localPath
              }}</code></span
            >
            <span>•</span>
        ...
        <a-space wrap class="docs-preview-actions">
          <a-button size="small" @click="openSnapshot(entry.localPath)"
            ><FileOutlined /> Open snapshot</a-button
          >
          <a-button size="small" @click="openDocs(entry.url)"
            ><LinkOutlined /> Open source</a-button
          >
          <a-button
            size="small"
            @click="copyText(entry.url, 'Source URL copied')"
            ><CopyOutlined /> Copy source URL</a-button
          >
          <a-button size="small" @click="reloadCurrent"
            ><ReloadOutlined /> Reload</a-button
          >
        </a-space>
          ...
          <a-tab-pane key="outline">
            <template #tab>
              <span class="docs-preview-tab-title"
                ><OrderedListOutlined /><span>Outline</span></span
              >
            </template>
          ...
          <a-tab-pane key="source" tab="Source">
            <div class="docs-source-scroll">
              <div class="docs-source-toolbar">
                ...
                <a-button
                  size="small"
                  @click="copyText(sourceText, 'Snapshot source copied')"
                  ><CopyOutlined /> Copy snapshot</a-button
                >
              </div>
              <pre class="docs-source-pre">{{
                sourceText || "No source content loaded yet."
              }}</pre>
            </div>
          </a-tab-pane>
        </a-tabs>
