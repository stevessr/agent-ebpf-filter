...
const loadSampleDemo = async () => {
  ...
  if (count > 0)
    message.success(`Loaded ${count} bundled AgentSight sample events`);
    ...
    <a-card :bordered="false" class="agentsight-shell">
      ...
      <template #extra>
        <a-space wrap>
          ...
          <a-badge
            ...
            :text="state.isTLSConnected.value ? 'TLS live' : 'TLS offline'"
          />
          <a-badge
      ...
      <a-card size="small" :title="t.traceImport" class="agentsight-import">
        <a-space direction="vertical" style="width: 100%">
          <a-space wrap>
            <a-upload
              :before-upload="beforeUploadTrace"
