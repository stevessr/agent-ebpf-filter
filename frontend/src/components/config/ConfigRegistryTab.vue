...
import {
  getCategoryColor,
  type useConfigRegistry,
} from "../../composables/config/useConfigRegistry";
                ...
                >
                  ...
                  <div style="display: flex; flex-wrap: wrap; gap: 6px">
                    <a-tag
                      ...
                      :color="
                        entry.disabled ? 'default' : getCategoryColor(tag)
                      "
                    >
                      <span
                        :style="
            ...
            >
              ...
              <div style="display: flex; flex-wrap: wrap; gap: 6px">
                <a-tag
                  ...
                  :key="p.path"
                  closable
                  @close.prevent="removePath(p.path!)"
                  :color="getCategoryColor(tag)"
                  >{{ p.path }}</a-tag
                >
              </div>
            ...
            >
              ...
              <div style="display: flex; flex-wrap: wrap; gap: 6px">
                <a-tag
                  ...
                  :key="prefix.prefix"
                  closable
                  @close.prevent="removePrefix(prefix.prefix!)"
                  :color="getCategoryColor(tag)"
                  >{{ prefix.prefix }}</a-tag
                >
              </div>
