...
const {
  ...
  collectorHealth, otelHealth, otlpHeadersText, domainForwardRoutesText, domainForwardStatus,
          ...
          <a-col :xs="24" :md="12">
            <div style="display: flex; flex-direction: column; gap: 12px">
              ...
              <a-alert
                type="warning"
                show-icon
                message="Binding 80/443 requires root or CAP_NET_BIND_SERVICE. HTTPS forwarding requires a default certificate or route-level cert/key files."
              ...
              <a-typography-text type="secondary">
                Changes are applied live by restarting the forwarding listeners; active proxied connections may be dropped during the switch.
              </a-typography-text>
            </div>
          </a-col>
          <a-col :xs="24" :md="12">
            <div style="display: flex; flex-direction: column; gap: 12px">
              <div style="font-weight: 600">Route overrides JSON</div>
              <a-textarea
                v-model:value="domainForwardRoutesText"
                :rows="13"
                placeholder='[
  {
    "host": "example.com",
