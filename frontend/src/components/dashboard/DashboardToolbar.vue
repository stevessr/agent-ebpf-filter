  ...
  <div class="dashboard-toolbar">
    <div style="display: flex; justify-content: space-between; align-items: center; gap: 12px; flex-wrap: wrap; width: 100%;">
      <div style="display: flex; align-items: center; gap: 16px;">
        ...
        <a-button @click="emit('update:isPaused', !isPaused)" :type="isPaused ? 'primary' : 'default'" size="small" danger>
        ...
        <a-checkbox :checked="showAllRows" @update:checked="emit('update:showAllRows', $event)">
          <span style="font-size: 12px;">No Page Limit</span>
        </a-checkbox>
        <a-checkbox :checked="hideUnknown" size="small" @update:checked="emit('update:hideUnknown', $event)">
          <span style="font-size: 12px;">Hide Unknown</span>
        </a-checkbox>
        <a-checkbox :checked="isDeduplicated" size="small" @update:checked="emit('update:isDeduplicated', $event)">
      ...
      <div style="display: flex; gap: 8px; align-items: center;">
        ...
        <a-select :value="maxEvents" size="small" style="width: 80px" @update:value="emit('update:maxEvents', $event)">
