...
export const linkStrokeWidth = (kind: string) => (kind === 'alerted' || kind === 'blocked' ? 2.4 : 1.4);
...
export const processTreeEdgeKinds = new Set(['child_process', 'parent_process', 'exec_chain', 'spawned']);
export const activityEdgeKinds = new Set(['observed', 'execed', 'waited', 'exited', 'reviewed', 'alerted']);
