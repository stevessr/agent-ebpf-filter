        ...
        >
          ...
          <div class="map-blueprint-canvas">
            ...
            <div class="map-node node-right">
              <div
                class="node-title"
                style="color: #1677ff; border-bottom-color: #91caff"
              >
                DECISION
              </div>
            ...
            <div
              v-if="localMode === 'NONE'"
              class="map-node node-center-bypass"
            >
              <div
                class="node-title"
                style="color: #4096ff; border-bottom-color: #91caff"
              >
                BYPASS
              </div>
            ...
            <template v-if="localMode === 'COUNTER'">
              ...
              <div class="map-node node-mid-left">
                ...
                <div class="node-content val-highlight">
                  {{ localKeyField.toUpperCase() }}
                </div>
              </div>
              ...
              <div class="map-node node-mid-right map-db-node">
                ...
                <div class="db-grid">
                  ...
                  <div class="db-row font-mono">
                    <span class="db-k"
                      >#{{ localKeyField === "comm" ? "nc" : "1001" }}</span
                    >
                    <span class="db-v val-warn"
                      >{{ localLimit > 2 ? localLimit - 1 : 1 }} /
                      {{ localLimit }}</span
                    >
                  </div>
                  <div class="db-row font-mono trigger-row">
                    <span class="db-k"
                      >#{{ localKeyField === "comm" ? "curl" : "1024" }}</span
                    >
            ...
            <template v-if="localMode === 'BLOCKLIST'">
              ...
              <div class="map-node node-mid-right map-db-node">
                ...
                <div class="db-grid">
                  ...
                  <div class="db-row font-mono trigger-row">
                    <span class="db-k"
                      >#{{ localKeyField === "comm" ? "nc" : "0" }}</span
                    >
                    <span class="db-v val-danger">TRUE 🚫</span>
                  </div>
                  <div class="db-row font-mono">
                    <span class="db-k"
                      >#{{ localKeyField === "comm" ? "python" : "1000" }}</span
                    >
