...
> Source: https://man7.org/linux/man-pages/man2/linkat.2.html
> Cached: 2026-04-28
...
```
link() SVr4, 4.3BSD, POSIX.1-2001 (but see VERSIONS). linkat() POSIX.1-2008. Linux 2.6.16, glibc 2.4. 
```
