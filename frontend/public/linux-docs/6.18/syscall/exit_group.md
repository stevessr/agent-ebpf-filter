...
> Source: https://man7.org/linux/man-pages/man2/exit_group.2.html
> Cached: 2026-04-28
...
# exit\_group(2) — Linux manual page

|  |
| --- |
| [NAME](#NAME) | [LIBRARY](#LIBRARY) | [SYNOPSIS](#SYNOPSIS) | [DESCRIPTION](#DESCRIPTION) | [RETURN VALUE](#RETURN_VALUE) | [STANDARDS](#STANDARDS) | [HISTORY](#HISTORY) | [NOTES](#NOTES) | [SEE ALSO](#SEE_ALSO) | [COLOPHON](#COLOPHON) |
|  |  |
...
```
#include  /* Definition of SYS_* constants */ #include  [[noreturn]] void syscall(SYS_exit_group, int status); Note: glibc provides no wrapper for exit_group(), necessitating the use of syscall(2). 
```
...
```
Linux man-pages 6.16 2025-05-17 exit_group(2)
```

---

Pages that refer to this page: [\_exit(2)](../man2/_exit.2.html),  [ptrace(2)](../man2/ptrace.2.html),  [seccomp(2)](../man2/seccomp.2.html),  [syscalls(2)](../man2/syscalls.2.html)
