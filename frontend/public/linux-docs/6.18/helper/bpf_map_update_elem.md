...
> Source: https://docs.ebpf.io/linux/helper-function/bpf_map_update_elem/
> Cached: 2026-04-28
...
<span class="md-ellipsis"> bpf_map_update_elem </span> <span class="md-nav__icon md-icon"></span> <a href="./" class="md-nav__link md-nav__link--active"><span class="md-ellipsis"> bpf_map_update_elem </span></a>
...
- <a href="#usage" class="md-nav__link"><span class="md-ellipsis"> Usage </span></a>
  ...
  - <a href="#map-types" class="md-nav__link"><span class="md-ellipsis"> Map types </span></a>
...
<span class="k">`static`</span><span class="w">` `</span><span class="kt">`long`</span><span class="w">` `</span><span class="p">`(`</span><span class="o">`*`</span><span class="w">` `</span><span class="k">`const`</span><span class="w">` `</span><span class="n">`bpf_map_update_elem`</span><span class="p">`)(`</span><span class="kt">`void`</span><span class="w">` `</span><span class="o">`*`</span><span class="n">`map`</span><span class="p">`,`</span><span class="w">` `</span><span class="k">`const`</span><span class="w">` `</span><span class="kt">`void`</span><span class="w">` `</span><span class="o">`*`</span><span class="n">`key`</span><span class="p">`,`</span><span class="w">` `</span><span class="k">`const`</span><span class="w">` `</span><span class="kt">`void`</span><span class="w">` `</span><span class="o">`*`</span><span class="n">`value`</span><span class="p">`,`</span><span class="w">` `</span><span class="n">`__u64`</span><span class="w">` `</span><span class="n">`flags`</span><span class="p">`)`</span><span class="w">` `</span><span class="o">`=`</span><span class="w">` `</span><span class="p">`(`</span><span class="kt">`void`</span><span class="w">` `</span><span class="o">`*`</span><span class="p">`)`</span><span class="w">` `</span><span class="mi">`2`</span><span class="p">`;`</span>
...
- [`BPF_MAP_TYPE_ARRAY`](../../map-type/BPF_MAP_TYPE_ARRAY/)
- [`BPF_MAP_TYPE_HASH`](../../map-type/BPF_MAP_TYPE_HASH/)
- [`BPF_MAP_TYPE_LPM_TRIE`](../../map-type/BPF_MAP_TYPE_LPM_TRIE/)
- [`BPF_MAP_TYPE_LRU_HASH`](../../map-type/BPF_MAP_TYPE_LRU_HASH/)
- [`BPF_MAP_TYPE_LRU_PERCPU_HASH`](../../map-type/BPF_MAP_TYPE_LRU_PERCPU_HASH/)
- [`BPF_MAP_TYPE_PERCPU_ARRAY`](../../map-type/BPF_MAP_TYPE_PERCPU_ARRAY/)
- [`BPF_MAP_TYPE_PERCPU_HASH`](../../map-type/BPF_MAP_TYPE_PERCPU_HASH/)
- [`BPF_MAP_TYPE_SOCKHASH`](../../map-type/BPF_MAP_TYPE_SOCKHASH/)
- [`BPF_MAP_TYPE_SOCKMAP`](../../map-type/BPF_MAP_TYPE_SOCKMAP/)
