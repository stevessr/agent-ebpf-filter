...
- provides ML subtabs for status / parameters / model management / training-set management, plus an auto-parameter-tuning heatmap on the parameters tab for comparing tree count, depth, and leaf-size combinations
